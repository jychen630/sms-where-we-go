...
export const fetchSchool = async ({ offset, limit, value }: PaginatedQuery) => {
    try {
        const result = await Service.getSchool(offset, limit, value);
...
const SchoolSearchTool = ({
    ...
    schoolUid: number;
    setSchoolUid: React.Dispatch<React.SetStateAction<number>>;
    initialValue?: string;
    searchProps?: SearchProps;
    onUpdate?: (school?: QuerySchoolResult) => void;
}) => {
