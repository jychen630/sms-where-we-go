...
type AboutData = { category: string, isBlocks?: boolean, items: (string | JSX.Element)[] }
...
const AboutPage = () => {
    ...
    const data: AboutData[] = [
        ...
        },
        {
            ...
            isBlocks: true,
            items: [
                <Button size='large' type='link' icon={<GithubOutlined />} target='_blank' href="https://github.com/AcKindle3/sms-where-we-go">
                    欢迎各位star, 提issue和PR
                </Button>,
            ]
        },
        {
            category: t("Misc"),
            items: [
                <Button size='large' onClick={showModal} icon={<BookOutlined />}>用户隐私协议</Button>,
            ]
        },
    ]
